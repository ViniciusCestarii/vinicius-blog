...
<Aside>
    <LinkPreview url="https://github.com/ViniciusCestarii/vinicius-blog/tree/main/examples/jwt">This example code is available on my github</LinkPreview>. You can run it with `set SECRET_KEY=secret && node app.mjs`
</Aside>
