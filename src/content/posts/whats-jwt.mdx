...
updatedAt: "2024-11-01T19:48:29.503Z"
status: "published"
tags: 
- "jwt"
- "security"
...
<Aside>
    This example code is avaible <LinkPreview url="https://github.com/ViniciusCestarii/vinicius-blog/tree/main/examples/jwt">`here`</LinkPreview>. You can run it with `set SECRET_KEY=secret && node app.mjs`
</Aside>
