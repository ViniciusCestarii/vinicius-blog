...
The client stores the token, usually in <LinkPreview url="https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage">`localStorage`</LinkPreview> or <LinkPreview url="https://developer.mozilla.org/en-US/docs/Web/HTTP/Cookies">`cookies`</LinkPreview>, and sends it with every request to the server.
